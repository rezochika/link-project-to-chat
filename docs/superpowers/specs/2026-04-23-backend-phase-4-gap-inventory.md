...
**Two shipped on 2026-04-26** (commit `93f8b9c`):
...
The post-`93f8b9c` Codex `False` flags (`supports_thinking`, `supports_permissions`, `supports_compact`, `supports_allowed_tools`, `supports_usage_cap_detection`) all reflect genuine CLI-surface absence, not adapter conservatism.
